...
EXECUTABLES = test_image test_2D calcul_contour
...
calcul_contour.o: calcul_contour.c calcul_contour.h image.h exemple_sequence_point.h
	@echo ""
	@echo "---------------------------------------------"
...
calcul_contour: calcul_contour.o image.o exemple_sequence_point.o geometrie_2D.o
	@echo ""
	@echo "---------------------------------------------"
	@echo "Creation de l'executable "$@
	@echo "---------------------------------------------"
