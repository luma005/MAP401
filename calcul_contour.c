...
void creat_eps(FILE* f, Contour C, UINT h, UINT l){
...
int main(int argc, char** argv){
    ...
    while (image_vide(m)==0){
        ...
        int j1=0;
        int j2=(c.taille)-1;
        c=douglas_peucker(c, j1,j2, d);
        t=t+c.taille; // t=nombre de points apres simplification pour chaque contour
        creat_eps(f,c, h, l);
        liberer_liste_point(c);
    }
